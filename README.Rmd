...
[![Travis-CI Build Status](https://travis-ci.org/coatless/sitmo.svg?branch=master)](https://travis-ci.org/coatless/sitmo) [![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/sitmo)](http://cran.r-project.org/package=sitmo)
